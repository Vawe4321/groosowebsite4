  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={item.cover} objectFit='cover' width={760} height={760} alt={'Course ' + item.id} />
        </Box>
        <Box sx={{ mb: 2 }}>
          <Typography component="h2" variant="h5" sx={{ mb: 2, height: 56, overflow: 'hidden', fontSize: '1.2rem' }}>
            {item.title}
          </Typography>
          <Typography component="h3" variant="h3" color="primary.main" sx={{ mb: 2, height: 56, overflow: 'hidden', fontSize: '0.8rem' }}>
            {item.description}
          </Typography>
